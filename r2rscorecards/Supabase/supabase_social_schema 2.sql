...
CREATE INDEX IF NOT EXISTS idx_friend_requests_pending ON friend_requests(from_user_id, to_user_id, status);
...
-- Grant permissions (no sequences needed for UUID primary keys)
